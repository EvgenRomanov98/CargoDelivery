...
public enum Role {
    USER(1, ROOT, AUTH, REGISTRATION, CALCULATE_PRICE, REGIONS, PAGINATION, VALIDATE),
    AUTHORIZE_USER(2, ROOT, CALCULATE_PRICE, REGIONS,
            PAGINATION, CREATE_DELIVERY, PRIVATE_OFFICE, PAY, RECEIPT, SIGN_OUT, VALIDATE),
    MANAGER(3, ROOT, MANAGEMENT, PAGINATION, SIGN_OUT, UPDATE_DELIVERY_DATE, CHANGE_STATUS, XLS, VALIDATE);
